...
impl<'a> Parser<'a> {
        ...
        while self.i < self.tokens.len() {
            ...
            match curr.typ {
                ...
                TokenType::Word => match curr.word {
                    ...
                    "widget_class" => {
                        let w = self.consume_widget_class();
    ...
    fn consume_widget_class(&mut self) -> WidgetClass {
        let mut w = WidgetClass::default();
        self.i += 1;
    ...
    fn consume_widget_props(&mut self, w: &mut HasWidgetProps) {
